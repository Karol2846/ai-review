...
You are invoked as a subagent by the `ai-review` orchestrator. It gives you one file path plus its
diff (and you may read the file for context). Review only that file and return findings as a JSON
array — nothing else.
